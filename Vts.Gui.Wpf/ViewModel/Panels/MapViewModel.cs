...
public class MapViewModel : BindableObject
{
    ...
    public bool ManualScale
    {
        ...
        {
            _autoScale = !value;
            OnPropertyChanged(nameof(ManualScale));
    ...
    public OptionViewModel<ScalingType> ScalingTypeOptionVm
    {
        ...
        set
        {
            ...
            OnPropertyChanged(nameof(ScalingTypeOptionVm));
        }
    }
    ...
    public OptionViewModel<ColormapType> ColormapTypeOptionVm
    {
        ...
        set
        {
            ...
            OnPropertyChanged(nameof(ColormapTypeOptionVm));
        }
    }
    ...
    public void UpdateImages()
    {
        ...
        OnPropertyChanged(nameof(Bitmap));
        OnPropertyChanged(nameof(ColorBar));
        OnPropertyChanged(nameof(YExpectationValue));
    }
