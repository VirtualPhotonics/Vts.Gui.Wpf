...
public class PlotViewModel : BindableObject, ITextFileService
{
    ...
    public PlotPointCollection PlotSeriesCollection
    {
        ...
        {
            field = value;
            OnPropertyChanged(nameof(PlotSeriesCollection));
        }
    }
    ...
    public bool HoldOn
    {
        ...
        {
            _holdOn = value;
            OnPropertyChanged(nameof(HoldOn));
        }
    }
    ...
    public bool ShowInPlotView
    {
        ...
        set
        {
            ...
            OnPropertyChanged(nameof(ShowInPlotView));
        }
    }
    ...
    public bool ShowAxes
    {
        ...
        {
            _showAxes = value;
            OnPropertyChanged(nameof(ShowAxes));
        }
    }
    ...
    public OptionViewModel<ScalingType> XAxisSpacingOptionVm
    {
        ...
        set
        {
            ...
            OnPropertyChanged(nameof(XAxisSpacingOptionVm));
        }
    }
    ...
    public OptionViewModel<ScalingType> YAxisSpacingOptionVm
    {
        ...
        set
        {
            ...
            OnPropertyChanged(nameof(YAxisSpacingOptionVm));
        }
    }
    ...
    public OptionViewModel<PlotToggleType> PlotToggleTypeOptionVm
    {
        ...
        set
        {
            ...
            OnPropertyChanged(nameof(PlotToggleTypeOptionVm));
        }
    }
    ...
    public IndependentVariableAxis CurrentIndependentVariableAxis
    {
        ...
        set
        {
            ...
            field = value;
            OnPropertyChanged(nameof(CurrentIndependentVariableAxis));
        }
    }
    ...
    public OptionViewModel<PlotNormalizationType> PlotNormalizationTypeOptionVm
    {
        ...
        set
        {
            ...
            OnPropertyChanged(nameof(PlotNormalizationTypeOptionVm));
        }
    }
    ...
    public string CustomPlotLabel
    {
        ...
        {
            field = value;
            OnPropertyChanged(nameof(CustomPlotLabel));
        }
    }
    ...
    public IList<string> PlotTitles
    {
        ...
        {
            field = value;
            OnPropertyChanged(nameof(PlotTitles));
        }
    }
    ...
    public bool AutoScaleX
    {
        ...
        {
            _autoScaleX = value;
            OnPropertyChanged(nameof(AutoScaleX));
            OnPropertyChanged(nameof(ManualScaleX));
        }
    }
    ...
    public bool AutoScaleY
    {
        ...
        {
            _autoScaleY = value;
            OnPropertyChanged(nameof(AutoScaleY));
            OnPropertyChanged(nameof(ManualScaleY));
        }
    }
