    ...
    public class ForwardSolverViewModel : BindableObject
    {
        ...
        private PlotAxesLabels GetPlotLabels()
        {
            ...
            var axesLabels = new PlotAxesLabels(
                ...
                sd.ConstantAxesVMs)
            {
                // it is a complex plot if the computation factory returns true and it the plot toggle is true and set to either amplitude or phase
                IsComplexPlot = (ComputationFactory.IsComplexSolver(SolutionDomainTypeOptionVM.SelectedValue) && !ShowComplexPlotToggle) || (ShowComplexPlotToggle && PhaseAmpToggleOptionVm.SelectedValue == PlotToggleType.Complex)
            };
            return axesLabels;
        }
        ...
        private IDataPoint[][] GetDataPoints(double[] reflectance)
        {
            ...
            var isComplexPlot = (ComputationFactory.IsComplexSolver(SolutionDomainTypeOptionVM.SelectedValue) && !ShowComplexPlotToggle) || (ShowComplexPlotToggle && PhaseAmpToggleOptionVm.SelectedValue == PlotToggleType.Complex);
